...
public class IrepStudyActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_irep_study);
		initView();
		setListener();
	...
	private void loadWebView() {
		...
		web_terminology.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				Loger.i(failingUrl);
				Toast.makeText(IrepStudyActivity.this, "页面加载失败",
			...
			public void onFormResubmission(WebView view, Message dontResend,
				...
				Toast.makeText(IrepStudyActivity.this, "不可重复提交，按Back回到上级网页",
		...
		String url = "file:///android_asset/irep_mobile_api_prc.html"; // js代码卸载t.html里
		IrepUser irepUser = new IrepUser();
		web_terminology.addJavascriptInterface(irepUser, "IrepUser");
		web_terminology.loadUrl(url);
	}

	public class IrepUser {
		public JSONObject getCurrentUID() {
			try {
				JSONObject test = new JSONObject();
				test.put("currentUID", StoreSession.getIrepSessionId());
				Loger.d("GetManeuverInfo----------");
				return test;
			} catch (Exception e) {
				e.printStackTrace();
			}
